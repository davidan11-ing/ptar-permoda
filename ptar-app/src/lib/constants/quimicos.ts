export const QUIMICOS = [
  ...
  { id: 'Q-06', sistema: 'RO'   as const, nombre: 'HCL 10%',           unidad: 'L', capacidad: 200, densidad: 1.048, nivel_inicial: 0, precio_kg: 0 },
  { id: 'Q-07', sistema: 'RO'   as const, nombre: 'Kuriverter IK-220',  unidad: 'L', capacidad: 200, densidad: 1.050, nivel_inicial: 0, precio_kg: 0 },
  { id: 'Q-08', sistema: 'RO'   as const, nombre: 'Vitec 7000',         unidad: 'L', capacidad: 200, densidad: 1.030, nivel_inicial: 0, precio_kg: 0 },
  // ── Sistema PTAP ─────────────────────────────────────────────────────────
