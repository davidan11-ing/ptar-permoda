...
import { getGemEficiencia, GemEficienciaRow } from '../../../services/ptarClient';
...
export default function GemCostoWidget({ fechaInicio, fechaFin }: Props) {
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <ComposedChart data={data} margin={{ top: 8, right: 40, bottom: 4, left: 4 }}>
        ...
        <Line yAxisId="right" dataKey="pesos_por_m3" stroke="#3fb950" strokeWidth={2} dot={false} />
      </ComposedChart>
    </ResponsiveContainer>
  );
}
